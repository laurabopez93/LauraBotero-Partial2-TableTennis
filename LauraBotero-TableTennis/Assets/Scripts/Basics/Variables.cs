...
public class Variables : MonoBehaviour {
    ...
    */
    ...
    public bool esMachito;
    public bool esUnaGirla;
    public bool estasEnLaFriendzone;
    public int edad;
    public float altura;
    ...
    int profundidad = -130;
    float distancia = 970.7f;
    string nombre = "zapote";
    ...
    void Start() {
        ...
        altura = 1.75f;
        presentacion = "Mi nombre es Zapoter";
        esMachito = false;
